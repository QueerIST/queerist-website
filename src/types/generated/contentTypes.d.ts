...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
    Schema.Attribute.Private
    Meta: Schema.Attribute.Component<'meta.page-meta', false> &
    Schema.Attribute.Required
    publishedAt: Schema.Attribute.DateTime
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Pin: Schema.Attribute.Enumeration<
    [
    ...
    > &
    Schema.Attribute.Required &
    Schema.Attribute.DefaultTo<'Instituto Superior T\u00E9cnico'>
...
export interface ApiHubHub extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required
    ImageBackgroundColor: Schema.Attribute.String &
    Schema.Attribute.Required &
    Schema.Attribute.CustomField<'plugin::color-picker.color'>
    locale: Schema.Attribute.String & Schema.Attribute.Private
    ...
    Name: Schema.Attribute.String & Schema.Attribute.Required
    publishedAt: Schema.Attribute.DateTime
    SeeMoreText: Schema.Attribute.String & Schema.Attribute.Required
    Series: Schema.Attribute.Relation<'oneToMany', 'api::serie.serie'>
    Slug: Schema.Attribute.UID<'Name'> & Schema.Attribute.Required
...
export interface ApiProjectPageProjectPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    Schema.Attribute.Private
    Hubs: Schema.Attribute.Relation<'oneToMany', 'api::hub.hub'>
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<
    'oneToMany',
...
export interface ApiSerieSerie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Hub: Schema.Attribute.Relation<'manyToOne', 'api::hub.hub'>
    Image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required
    locale: Schema.Attribute.String & Schema.Attribute.Private
...
export interface ApiSubpageSubpage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >
    Child: Schema.Attribute.Relation<'oneToMany', 'api::subpage.subpage'>
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    Schema.Attribute.Private
    ...
    Schema.Attribute.Private
    Name: Schema.Attribute.String & Schema.Attribute.Required
    Parent: Schema.Attribute.Relation<'manyToOne', 'api::subpage.subpage'>
    publishedAt: Schema.Attribute.DateTime
    Slug: Schema.Attribute.UID<'Name'> & Schema.Attribute.Required
    TextColor: Schema.Attribute.String &
    Schema.Attribute.Required &
